...
class DirectorsTestCase(unittest.TestCase):
    ...
    def test_director_is_inique(self):
        self.assertTrue(
            self.student_func_output != list(set(self.student_func_output)),
    ...
    def test_result_is_correct(self):
        self.assertEqual(
            ...
            'Проверьте, правильно ли выбран параметр Column при запросе')
    ...
    def test_output_not_contains_wrong_symbols(self):
        startssymbols = ('(', '[', '{')
        endssymbols = (')', ']', '}')
